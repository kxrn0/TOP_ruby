...
describe "divisibility" do
  matcher :be_divisible_by do |n|
    match { |m| (m % n).zero? }
  end

  context "when a number is divisible by three" do
    it "9 is divisible by three" do
      expect(9).to be_divisible_by(3)
    end
  end
end
